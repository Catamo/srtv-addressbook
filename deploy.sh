...
heroku container:release api --app srtv-addressbook-catamo-victor
heroku container:release users_worker --app srtv-addressbook-msusers
heroku container:release contacts_worker --app srtv-addressbook-mscontacts